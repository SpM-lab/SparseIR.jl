@testitem "Augmented bosonic basis" begin
    using LinearAlgebra
...
@testsnippet AugmentedBasisSetup begin
    β = 1000
    ωmax = 2
    basis = FiniteTempBasis{Bosonic}(β, ωmax, 1e-6)
    basis_aug = AugmentedBasis(basis, TauConst, TauLinear)
...
@testitem "getindex" setup=[AugmentedBasisSetup] begin
...
@testitem "accessor functions" setup=[AugmentedBasisSetup] begin
