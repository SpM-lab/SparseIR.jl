...
4-element Vector{ComplexF64}:
 0.14769927083929674 + 0.05523939812015521im
  0.0745320238849433 + 0.08362473524789882im
 0.03743898457178096 + 0.07001073743367174im
 0.02143634755864479 + 0.05612022667503004im
```
...
julia> giw = transpose(basis.uhat([1, 3, 5, 7])) * gl
4-element Vector{ComplexF64}:
  0.3996422393827959 + 0.01195726784103936im
 0.39680302944831924 + 0.03561695663534312im
   0.391243938997219 + 0.05852995640548554im
  0.3831913466601924 + 0.08025540797245599im
```
